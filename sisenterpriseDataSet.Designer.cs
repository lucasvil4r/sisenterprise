...
namespace SisEnterprise {
    ...
    public partial class sisenterpriseDataSet : global::System.Data.DataSet {
        ...
        public partial class funcionarioDataTable : global::System.Data.TypedTableBase<funcionarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public funcionarioRow AddfuncionarioRow(string name, string cpf) {
...
namespace SisEnterprise.sisenterpriseDataSetTableAdapters {
    ...
    public partial class funcionarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[funcionario] WHERE (([id] = @Original_id) AND ([name] = @Origi" +
                "nal_name) AND ([cpf] = @Original_cpf))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[funcionario] ([name], [cpf]) VALUES (@name, @cpf);\r\nSELECT id," +
                " name, cpf FROM funcionario WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[funcionario] SET [name] = @name, [cpf] = @cpf WHERE (([id] = @Origi" +
                "nal_id) AND ([name] = @Original_name) AND ([cpf] = @Original_cpf));\r\nSELECT id, " +
                "name, cpf FROM funcionario WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SisEnterprise.Properties.Settings.Default.sisenterpriseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, cpf FROM dbo.funcionario";
        ...
        public virtual int Fill(sisenterpriseDataSet.funcionarioDataTable dataTable) {
        ...
        public virtual sisenterpriseDataSet.funcionarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            sisenterpriseDataSet.funcionarioDataTable dataTable = new sisenterpriseDataSet.funcionarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(sisenterpriseDataSet.funcionarioDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_cpf) {
        ...
        public virtual int Insert(string name, string cpf) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string cpf, int Original_id, string Original_name, string Original_cpf, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string cpf, int Original_id, string Original_name, string Original_cpf) {
            return this.Update(name, cpf, Original_id, Original_name, Original_cpf, Original_id);
        }
    }
